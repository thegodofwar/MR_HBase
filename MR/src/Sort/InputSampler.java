...
public class InputSampler<K,V> implements Tool {
  ...
  public static class RandomSampler<K,V> implements Sampler<K,V> {
    ...
    public K[] getSample(InputFormat<K,V> inf, JobConf job) throws IOException {
      ...
      System.out.println("samples length:"+samples.size());
      System.out.println(Arrays.toString((K[])samples.toArray()));
      return (K[])samples.toArray();
    }
  }
  ...
  public static <K,V> void writePartitionFile(JobConf job,
    ...
    System.out.println("NumReduce:"+numPartitions);
    ...
    for(int i = 1; i < numPartitions; ++i) {
      ...
      System.out.println("partitions write:"+samples[k].toString()+"---"+nullValue.get().toString());
      last = k;
    }
    writer.close();
  }
