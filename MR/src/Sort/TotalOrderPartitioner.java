...
public class TotalOrderPartitioner<K extends WritableComparable,V>
  ...
  public void configure(JobConf job) {
    try {
      ...
      Class<K> valueClass = (Class<K>)job.getMapOutputValueClass();
      ...
      System.out.println("partFile:"+parts+" splitPoints:"+Arrays.toString(splitPoints));
      System.out.println(splitPoints.length+"*************"+(job.getNumReduceTasks() - 1));
